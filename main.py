...
def create_card(name, condition, price, description, typeofitem="Предмет", typeofdamage=None, damage=None, usage=None):    
...
for i in range(len(df)):
    ...
    create_card(name, condition, price, description, typeofitem, typeofdamage, damage, usage)